...
def main():
    ...
    table = 'tb_asignacion_movistar_v2_coalesce'
    
    cuenta = 'numero_identificacion'

    sql_file_path = r'C:\Users\Emerson.Aguilar\Documents\git_hub\Chubb\sql\_sql_coalesce_chubb_movistar.sql'
