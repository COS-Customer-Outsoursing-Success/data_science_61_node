"""
main_load_mensajeria_fidelizacion.py
-------------------------------------
Carga incremental del consolidado de envío SMS de fidelización al servidor .61.
Destino: bbdd_cos_bog_claro_fidelizacion.tb_sms_fidelizacion_ds
...
TABLE       = "tb_sms_fidelizacion_ds"
DIR_NUEVO   = os.path.join(ROOT_DIR, "data", "Bases_SMS", "Nuevo")
DIR_CARGADO = os.path.join(ROOT_DIR, "data", "Bases_SMS", "Cargado")
CHUNK_SIZE  = 5_000
LLAVE       = ["fecha_envio", "cuenta", "servicio"]    # llave única del consolidado
SHEET_NAME  = "SMS"                                    # pestaña del Excel a cargar
...
def main():
    print("=" * 60)
    print("  CARGUE INCREMENTAL MENSAJERÍA FIDELIZACIÓN → .61")
    print("=" * 60)
